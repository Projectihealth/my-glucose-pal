    ...
    <div className="min-h-screen w-full bg-white dark:bg-slate-950">
      ...
      >
        <div className="flex flex-col h-full">
          <header className="flex items-center justify-between px-6 pt-4 pb-3 text-[13px] font-semibold text-slate-500 bg-white dark:bg-slate-950 border-b border-slate-200/80 dark:border-slate-800">
          ...
          <main className={cn("flex-1 overflow-y-auto pb-20 relative", className)}>
            {children}
          </main>
