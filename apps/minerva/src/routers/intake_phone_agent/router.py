...
async def save_call_data_endpoint(request: Request):
    ...
    try:
        ...
        # 导入 MemoryService
        digital_avatar_dir = os.path.join(os.path.dirname(__file__), '../../digital_avatar')
        if digital_avatar_dir not in sys.path:
            sys.path.insert(0, digital_avatar_dir)
        ...
        try:
            ...
            memory_result = memory_service.process_conversation(
                ...
                transcript=transcript,  # 使用纯文本 transcript
